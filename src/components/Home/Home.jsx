                ...
                <div className='h-screen mt-16'>
                    <div className='w-full max-w-lg m-auto rounded-lg shadow-xl py-10 px-16'>
                        ...
                        <div className="relative max-w-xl">
                            <Link to={`/category/${item[0].id}`}><img src={item[0].imgUrl} className="absolute w-24 bottom-0 left-0 top-8" alt='foto-item' /></Link>
                            <Link to={`/category/${item[1].id}`}><img src={item[1].imgUrl} className="absolute w-24 bottom-0 right-0 top-4" alt='foto-item' /></Link>
                        </div>
